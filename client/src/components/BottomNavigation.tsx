...
export function BottomNavigation({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-[var(--ep-border)] bg-[var(--ep-surface)] px-1 pt-2 shadow-[0_-10px_28px_rgba(0,0,0,0.55)] bottom-nav-safe">
