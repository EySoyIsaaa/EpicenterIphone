...
final class NativePlaybackController {
    /// Single shared playback controller. Both the Capacitor plugin (phone UI) and the
    /// CarPlay scene must drive the SAME audio engine, queue and Epicenter state — two
    /// instances would mean two engines fighting over the audio session.
